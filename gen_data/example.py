...
parser.add_argument("--init_loc", type=int, required=True, help='initial location/seed idx')
parser.add_argument("--loc_num", type=int, required=True, help='total num of locations to be sampled')
parser.add_argument("--mode", type=str, default='nav', help='nav for navigation data, ptz for ptz data')
...
def make_settings():
    ...
    settings["init_loc"] = args.init_loc
    settings["loc_num"] = args.loc_num
    assert args.mode in ['nav', 'ptz']
